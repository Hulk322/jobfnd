...
export class AppliedJobsComponent implements OnInit {
  ...
  getAppliedJobs(){
    this.isLoading = true;
    this._JobService.getAppliedJobs(this.pageObj.page)
      .subscribe(
        data => this.handleSuccess(data),
        err => this.handleErrorStats(err)
      );
  }
  ...
  goToJob(jobSlug) {
    ///candidate/applied-jobs/', job.id
    this.router.navigate(['/candidate/applied-jobs/' + jobSlug]);
  }
