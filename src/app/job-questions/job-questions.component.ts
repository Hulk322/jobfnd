...
export class JobQuestionsComponent implements OnInit {
  ...
  handleSuccess(data){
    ...
    this.titleService.setTitle('SimplifyHire | Jobs - '+this.job.title);
...
localStorage.setItem('answers', JSON.stringify(answers));
    ...
    this._publicJobService.applyToJob(job_id, answers)
        .subscribe(
  ...
  {
    // GoogleAnalytics
    this.googleAnalyticsService.emitEvent(this.clientId,this.job.organization_id,"click", "apply_final", this.href, this.job.id);
