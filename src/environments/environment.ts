...
export const environment = {
    ...
    //https://api-product-test.zepptalentz.com
    baseApiUrlClient: 'https://api.jobboard.zepptalentz.com/job_board_bknd/public/api/v1',
    // baseApiUrl: 'https://talentzhire.com/job_board/public/api/v1',
    // baseApiUrlClient: 'https://talentzhire.com/job_board/public/api/v1',
